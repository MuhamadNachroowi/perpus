...
$data = mysqli_query($konek ,"SELECT COUNT(idtamu) FROM tamu");
                    ...
                    <div class="container">
                        ...
                        <form action="laporanTamuAnggota.php" method="GET">
                            <table class="table " align="center">
                                <tr width="100px">
                                    <td>
                                        DARI :<input class="form-control" type="date" name="tgl1"
                                            value="<?= date('Y-m-d')?>">
                                    </td>
                                    <td>
                                        SAMPAI :<input class="form-control" type="date" name="tgl2"
                                            value="<?= date('Y-m-d')?>">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a style="margin-bottom: 10px;" href="laporanTamuAnggota.php"><button
                                                class="btn btn-success bnt-sm">LAPORAN KUNJUNGAN
                                                ANGGOTA</button></a>
                        ...
                        <form action="laporanNonAnggota.php" method="GET">
                            <table class="table" align="center">
                                ...
                                <tr>
                                    <td>
                                        <a href="laporanNonAnggota.php"><button class="btn btn-success bnt-sm">LAPORAN
                                                KUNJUGAN NON
                                                ANGGOTA</button></a>
                                    </td>
                                </tr>
