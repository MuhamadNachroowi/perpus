...
<head>
    ...
    <div class="container">
        ...
        <p align="center" style=" margin-top:10px; font-weight: bold; color: red; font-family: arial;">Masukan Nomor
            Keanggotaan Anda Pada Kolom Dibawah ini!</p>
        <form action="" method="get">
            <table style="float: right;" class="table" width="400px">
                <tr>
                    ...
                    <td></td>
                    <td>
                        <input class="form-control" type="text" name="noanggota" placeholder="Masukan ID Anggota"
                            size="30">
                    </td>
                    <td></td>
...
?>
        <hr />
        <i style="margin-left: 10px;"> Pentium</i>
        <?php 
 if (isset($_POST['tambah'])){
 	...
 	if ($nama == '' || $Alamat =='' || $Tujuan ==''){
 		...
 		alert('SELAMAT DATANG DI PERPUSTAKAAN PENTIUM');
