        ...
        <table class=" table table bordered" align="center">
            <tr>
                ...
                <td>
                    ...
                    <input class="form-control" type="text" name="nama" size="30" maxlength="50"
                        value="<?= $ad['namalengkap'] ?>">
                </td>
            </tr>
            <tr>
                <td>Username</td>
                <td>:</td>
                <td>
                    <input class="form-control" type="text" name="username" size="30" max="50"
                        value="<?= $ad['username'] ?>">
                </td>
            </tr>
            <tr>
                ...
                <td>:</td>
                <td>
                    <input class="form-control" type="password" name="password" size="30" maxlength="20"
                        value="<?= $ad['password'] ?>">
                </td>
            </tr>
            <td></td>
